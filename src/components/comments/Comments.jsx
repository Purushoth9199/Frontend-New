...
export const CommentDescription = (props) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      const res = await axios.get(`https://finale.onrender.com/api/users/find/${props.com?.userId}`);
...
export const Comments = ({ videoId }) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const res = await axios.get(`https://finale.onrender.com/api/comments/${videoId}`);

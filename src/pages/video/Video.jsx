...
const Video = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const videoRes = await axios.get(`https://finale.onrender.com/api/videos/find/${path}`);
        console.log("video=", videoRes.data);
        const channelRes = await axios.get(
          `https://finale.onrender.com/api/users/find/${videoRes.data.userId}`
        );
  ...
  const handleLike = async () => {
    if (!currentUser) {
      ...
      await axios.put(`https://finale.onrender.com/api/users/like/${currentVideo._id}`);
  ...
  const handleDisLike = async () => {
    if (!currentUser) {
      ...
      await axios.put(`https://finale.onrender.com/api/users/dislike/${currentVideo._id}`);
  ...
  const handleSubscription = async () => {
    if (!currentUser) {
      ...
      currentUser.subscribedUsers.includes(channel._id)
        ? await axios.put(`https://finale.onrender.com/api/users/unsub/${channel._id}`)
        : await axios.put(`https://finale.onrender.com/api/users/sub/${channel._id}`);

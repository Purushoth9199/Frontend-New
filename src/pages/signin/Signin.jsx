...
const Signin = () => {
  ...
  const signInHandle = async (e) => {
    ...
    dispatch(loginStart());
    try {
      const res = await axios.post("https://finale.onrender.com/api/auths/signin", { email, password });
  ...
  const signinWithGoogle = async () => {
    ...
    await signInWithPopup(auth, provider)
      .then((result) => {
        ...
        axios
          .post("https://finale.onrender.com/api/auths/google", {
  ...
  const handleSignUp = async (e) => {
    ...
    dispatch(loginStart());
    try {
      const res = await axios.post("https://finale.onrender.com/api/auths/signup", {
        name: username,
        email: email,
        password: password,
      });
